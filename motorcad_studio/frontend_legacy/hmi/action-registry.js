...
(() => {
  ...
  const ACTION_ATTRIBUTES = [
    ...
    ['data-canonical-delete', 'SOLUTION_DELETE'],
  ...
  const SAFE_DELEGATED_SELECTORS = [
    ...
    '[data-canonical-create-solution]','[data-canonical-motor]','[data-canonical-analysis]','[data-canonical-delete]',
  ...
  const DEFERRED_OWNER_IDS = new Set();
