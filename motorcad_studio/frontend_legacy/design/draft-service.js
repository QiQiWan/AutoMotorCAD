 ...
 */
(() => {
  // Draft payloads are JSON API documents. Keep cloning independent of browser
  // Window receiver semantics so the sealed compatibility runtime cannot surface
  // WebIDL `Illegal invocation` errors while opening or autosaving an editor.
