...
(() => {
  ...
  window.MCSRouter={start,apply,navigate,parse,routeForTab,setUrl,isRouting,preferredRevisionEditor,syncDesignView,setRevisionEditMode,syncWizardStep(step){state.taskWizardStepV019=step;if(started&&!isRouting())navigate(routeForTab('analysisConfig'))}};
})();
