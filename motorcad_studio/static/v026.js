...
(() => {
  ...
  async function refreshExecutionLease(caseId, force = false) {
    ...
    try {
      ...
      if (response.status === 404) {
        box.innerHTML='<span class="eyebrow">Validate-and-Run 执行租约</span><p class="hint">当前 Case 正在建立租约，或属于 V0.25 及更早历史任务。</p>';
        return;
      }
  ...
  window.MCSV026 = {refreshWorkerPool, refreshExecutionLease, recycleWorkerPool};
})();
