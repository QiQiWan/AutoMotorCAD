/* MotorCAD Studio current frontend convergence primitives.
...
(() => {
  ...
  window.MCSAppCore={VIEW_ROUTES,ROUTE_VIEWS,STAGES,stageForView,routeSegmentsForView,viewForRoute,emit};
  document.documentElement.dataset.frontendConvergence='stable';
  document.body?.classList.add('studio-current');
})();
