/* V0.70 stable module; migrated from historical v027.js. */
...
(() => {
  ...
  window.MCSResourceScheduler = {refreshRuntimeScheduler, renderScheduler, renderContract, probeWorkerCapabilities};
})();
